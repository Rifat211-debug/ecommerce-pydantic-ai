# 👕 Clothstore AI Shopping Assistant ChatBot 
-------

[![Pydantic AI](https://img.shields.io/badge/Pydantic_AI-F05023?style=for-the-badge&logo=pydantic&logoColor=white)](https://ai.pydantic.dev/)
...
Welcome to **ClothStore AI**! This project is a modern LLM-powered shopping experience. It features a sleek **Frontend** (Vanilla JS), a robust **FastAPI Backend**, a **MongoDB** database, and an intelligent **AI Shopping Assistant** powered by **Pydantic AI**. It also deployed on **AWS** cloud.
...
## 📝 License
Distributed under the **MIT License**.Have fun building.Thank You!